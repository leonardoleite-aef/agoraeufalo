  ...
  renderSidebarNav: function(activeItem = 'courses') {
    return `
      <nav class="space-y-1.5 text-xs font-bold">
        ...
        <a href="treino/player.html" class="flex items-center gap-3 px-3.5 py-3 rounded-2xl ${activeItem === 'player' ? 'bg-[#F5EFE6] text-[#2C2416] border border-[#E8E0D2] shadow-xs' : 'text-[#6E675F] hover:text-[#2C2416] hover:bg-[#F9F6F0]'} transition">
          <i data-lucide="headphones" class="w-4 h-4 text-[#8C8275]"></i>
          <span>Training Player</span>
        </a>
