...
function App() {
  ...
  "documentTitle": "The Story of Grazi",
  "brandHeader": "MEU CURSO CUSTOMIZADO",
  "seriesHeader": "MÓDULO 1",
  "theme": {
    "themeId": "amber"
  },
  "blocks": [
    {
      "type": "INTRO",
      "tag": "[INTRO]",
      "focus": "This story introduces daily routines and the transition to a new life in a foreign country.",
      "keyChunks": ["wakes up at a quarter to six", "make a strong cup of coffee", "figure this out"],
      "grammarPoints": ["Present Simple for routines", "Past Simple for narratives"],
      "recommendations": ["Listen at least 3 times before trying to speak."],
      "roadblocks": ["Don't try to translate 'figure this out' literally."]
    },
    {
      "type": "LR",
      "tag": "[LR]",
      "paragraphs": [
        "Grazi is a 32-year-old software engineer living in São Paulo. She wakes up at a quarter to six every morning, makes a strong cup of coffee, and opens her laptop before the sun is even up.",
        "One day, her boss told her she had to move to London for a new project. She was terrified, but she knew she couldn't say no. 'I guess I have to figure this out', she thought."
      ]
    },
    {
      "type": "VOC",
      "tag": "[VOC]",
      "storyTranslation": [
        "Grazi é uma engenheira de software de 32 anos morando em São Paulo. Ela acorda quinze pras seis toda manhã, faz uma xícara forte de café, e abre o laptop antes mesmo do sol nascer.",
        "Um dia, o chefe dela disse que ela tinha que se mudar para Londres para um novo projeto. Ela estava apavorada, mas sabia que não podia dizer não. 'Acho que vou ter que dar um jeito nisso', ela pensou."
      ],
      "items": [
        {
          "type": "chunk",
          "target": "figure this out",
          "spokenTranslation": "dar um jeito nisso",
          "grammarNote": "Phrasal verb mais comum do inglês para 'resolver problema'."
        }
      ]
    },
    {
      ...
      "drills": [
        {
          "questionVariations": ["Did Grazi wake up at 8 AM?"],
          "negativeContext": "No, she didn't.",
          "answerVariations": ["She woke up at a quarter to six."]
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "drills": [
        {
          "negativeContext": "Grazi didn't wake up at 8 AM.",
          "questionVariations": ["What time did she wake up?"],
          "answerVariations": ["She woke up at a quarter to six."]
        }
      ]
    },
    {
      ...
      "tag": "[PRO]",
      "fullTextWithLinking": [
        "Grazi is a 32-year-old software engineer living in São Paulo.",
        "She wakes_up_at_a quarter to six every morning, makes_a strong cup of coffee,"
      ],
      "goldenTip": "Treine repetidamente até sua boca automatizar."
    },
    {
      "type": "QR_CODE",
      "tag": "[QR_CODE]",
      "url": "https://app.agoraeufalo.com/player?trackId=MS-001",
      "instruction": "Escaneie este código para escutar a história e praticar a fala"
    }
  ]
}`);
