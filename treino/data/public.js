/**
 * Public Showcase Session: AgoraEuFalo
 * English Personal Training Player - Demonstration Mode
  ...
  tracks: [
    {
      ...
      sentences: [
        ...
        },
        {
          ...
          "notes": "Speaker: Mark (Connected speech: 'if the weather holds up')"
        },
        {
          "id": 7,
          "start": 30.48,
          "end": 36.49,
          "text": "Sounds wonderful! I’ll probably just catch up on some reading and have coffee with a close friend.",
          "notes": "Speaker: Sarah (Natural resolution: 'have coffee with a close friend')"
        }
      ]
    }
  ]
