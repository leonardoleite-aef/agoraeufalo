...
- **A Regra Canônica de "Zero Traduções Óbvias":** Proibição absoluta de traduzir números universais (ex: `1973`), dias isolados ou termos que qualquer ser humano no mundo compreende visualmente. Traduções aplicam-se **SOMENTE** a frases/expressões contraintuitivas, idiomáticas ou onde a lógica do inglês diverge do português (ex: *"a quarter to five"* ➔ *"Quinze pras cinco"*, *"on May 4th"* ➔ *"No dia 4 de maio"*). Materiais e tabelas devem focar no **Bloco Sonoro (Melodia)** e no **Ponto de Confusão do Falante de Português**.
- **Os 2 Grandes Arquétipos Pedagógicos de Cursos:**
  1. **Masterclasses Clássicas / Cursos Temáticos (ex: Dates & Times, QuickStart, Gramática Viva):** Explicações Vivas do Sentimento da Estrutura, Tabelas de Melodia Sonora & Pontos Contraintuitivos, Casos de Uso Reais, Exercícios Pautados e Sacada de Ouro do Leo.
...
4. **`4. Look & Retell (LRT)` (Produção Própria & Speaking Ativo):** Reconto autônomo e livre com suas próprias palavras guiado por **estímulo visual** (as perguntas-guia de LA ou o **filme da história sem áudio**, quando disponível) *(AI Speech Coach permanece no roadmap futuro)*.
