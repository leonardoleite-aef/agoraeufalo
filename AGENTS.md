...
4. **`4. Look & Retell (LRT)` (Produção Própria & Speaking Ativo):**
   ...
   - **Zero áudio prévio e zero auto-scroll.** 100% Speaking autônomo. O aluno treina o reconto livre da história guiado pelas perguntas visuais e palavras-chave de apoio *(Nota: AI Speech Coach permanece no roadmap futuro, sem necessidade canônica nesta fase)*.
