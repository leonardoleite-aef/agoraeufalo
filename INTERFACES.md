...
| Interface | URL Produção | Arquivo Local | Descrição |
| :--- | :--- | :--- | :--- |
| **Command Center Geral** | [agoraeufalo.com.br/admin.html](https://agoraeufalo.com.br/admin.html) | [`admin.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/admin.html) | Painel central do Professor Leo: CRM de mentorados, métricas e atalhos rápidos. |
| **Course Studio (Gestor de Cursos)** | [agoraeufalo.com.br/admin-cursos.html](https://agoraeufalo.com.br/admin-cursos.html) | [`admin-cursos.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/admin-cursos.html) | Estúdio 3-colunas widescreen de criação de cursos, módulos, upload na nuvem e Agente de IA. |
...
| Interface | URL Produção | Arquivo Local | Descrição |
| :--- | :--- | :--- | :--- |
| **Portal do Aluno (Dashboard/Catálogo)** | [agoraeufalo.com.br/portal.html](https://agoraeufalo.com.br/portal.html) | [`portal.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/portal.html) | Área de membros dos alunos com catálogo de programas e métricas de estudo. |
