...
| **Course Studio (Fábrica de Cursos)** | [admin.agoraeufalo.com.br/cursos](https://admin.agoraeufalo.com.br/cursos) | [`admin-cursos.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/admin-cursos.html) | Estúdio 3-níveis de criação e gestão dinâmica de cursos, módulos e aulas integradas com sincronização bidirecional Firestore. |
