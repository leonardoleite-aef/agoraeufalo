...
| **Personal Training Player Unificado** | [agoraeufalo.com.br/treino/player.html](https://agoraeufalo.com.br/treino/player.html) | [`treino/player.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/treino/player.html) | Player SaaS com 5 Ambientes (*Sugestões do Leo*, *Magic Stories 2026*, *MS-Legacy Curso Clássico*, *Mentoria VIP*, *Minhas Coisas*), seletor das **6 Atividades Canônicas**, MediaSession API com capa 512x512 de alta definição na lockscreen do celular/AirPlay, auto-chaining contínuo, cortina blur revelável em LA/LASK e modo de transcrição corrida contínua. |
...
| Interface | URL Produção | Arquivo Local | Descrição |
| :--- | :--- | :--- | :--- |
| **Command Center Geral** | [agoraeufalo.com.br/admin.html](https://agoraeufalo.com.br/admin.html) | [`admin.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/admin.html) | Painel central do Professor Leo com métricas macro, fórum, CRM e atalhos rápidos unificados. |
...
| **Admin de Treinos** | [agoraeufalo.com.br/treino/admin.html](https://agoraeufalo.com.br/treino/admin.html) | [`treino/admin.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/treino/admin.html) | Painel de upload e calibração de faixas de alunos na estrutura local. |
...
| **Entrada no Curso (Showcase de Módulos)** | [agoraeufalo.com.br/curso.html](https://agoraeufalo.com.br/curso.html) | [`curso.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/curso.html) | Tela de entrada no curso estilo Hotmart Club com capas de módulos e lista de aulas. |
...
| **AEF Speech Coach Engine** | [`assets/js/ai/aef-speech-coach.js`](file:///Users/macbookpro/Desktop/agoraeufalo_site/assets/js/ai/aef-speech-coach.js) | Motor de gravação contínua do microfone (MediaRecorder) e avaliação de fala/chunks do Look-Retell-AI-Coach. |
