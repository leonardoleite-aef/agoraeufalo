...
| **Gestão do Player Público & Leads (Unificado no CRM)** | [agoraeufalo.com.br/admin-publico.html](https://agoraeufalo.com.br/admin-publico.html) | [`admin-publico.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/admin-publico.html) | Rota legada unificada no CRM de Alunos (`admin-alunos.html`) e Course Studio (`admin-cursos.html`) com redirecionamento automático. |
