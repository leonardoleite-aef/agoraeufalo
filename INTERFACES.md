...
| **Personal Training Player Unificado** | [agoraeufalo.com.br/treino/player.html](https://agoraeufalo.com.br/treino/player.html) | [`treino/player.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/treino/player.html) | Player SaaS com 4 Ambientes (*Sugestões do Leo*, *Magic Stories*, *Mentoria VIP*, *Minhas Coisas*), seletor das **6 Atividades Canônicas**, MediaSession API com capa 512x512 de alta definição na lockscreen do celular/AirPlay, auto-chaining contínuo, cortina blur revelável em LA/LASK e modo de transcrição corrida contínua. |
...
| Interface | URL Produção | Arquivo Local | Descrição |
| :--- | :--- | :--- | :--- |
| **Course Studio (Gestor de Cursos)** | [agoraeufalo.com.br/admin-cursos.html](https://agoraeufalo.com.br/admin-cursos.html) | [`admin-cursos.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/admin-cursos.html) | Estúdio 3-níveis de criação de cursos, módulos e aulas conectadas ao Player. |
| **Alunos & Equipe (RBAC)** | [agoraeufalo.com.br/admin-alunos.html](https://agoraeufalo.com.br/admin-alunos.html) | [`admin-alunos.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/admin-alunos.html) | Gestão de alunos, atribuição de planos (Free, Pro, VIP) e permissões. |
...
| Interface | URL Produção | Arquivo Local | Descrição |
| :--- | :--- | :--- | :--- |
| **Dashboard do Aluno (Portal Central)** | [agoraeufalo.com.br/portal.html](https://agoraeufalo.com.br/portal.html) | [`portal.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/portal.html) | Centro de comando do aluno com telemetria de listening time, streak, mural/fórum, YouTube Lab e cursos. |
...
| **Meu Repertório de Frases** | [agoraeufalo.com.br/repertorio.html](https://agoraeufalo.com.br/repertorio.html) | [`repertorio.html`](file:///Users/macbookpro/Desktop/agoraeufalo_site/repertorio.html) | Portal dedicado de automação oral com banco de chunks e áudio em 1 toque. |
...
| :--- | :--- | :--- |
| **Livro Oficial MS001 (Grazi)** | [`Material-PDF/MS001_Grazi_wants_to_change_Apostila_Oficial.pdf`](file:///Users/macbookpro/Desktop/agoraeufalo_site/Material-PDF/MS001_Grazi_wants_to_change_Apostila_Oficial.pdf) | **Template Canônico dos 3 Arquétipos em 8 Páginas (Fontes 13.5 a 17pt):**<br/>• **P1 (Capa Deep Navy):** Fundo Solid Deep Navy, número d'água `"01"`, arte 1:1, ficha técnica e sinopse.<br/>• **P2 & P3 (LR & VOC Parte 1):** História da Grazi em 16.5pt e Tradução Falada Real.<br/>• **P4 (VOC Deep Dive):** Análise contextual e chunks funcionais.<br/>• **P5 a P8 (Practice Workbook):** LA sem respostas impressas, palco Look & Retell AI Coach, LASK sem perguntas reveladas e PRO com texto integral de LR com linking sounds e Sacada de Ouro. |
| **Livro Oficial MS002 (Tom)** | [`Material-PDF/MS002_Tom_workaholic_CEO_Apostila_Oficial.pdf`](file:///Users/macbookpro/Desktop/agoraeufalo_site/Material-PDF/MS002_Tom_workaholic_CEO_Apostila_Oficial.pdf) | **Template Canônico dos 3 Arquétipos em 8 Páginas (Fontes 13.5 a 17pt):**<br/>• **P1 (Capa Deep Navy):** Fundo Solid Deep Navy, número d'água `"02"`, foto real do Tom 1:1, ficha técnica e sinopse.<br/>• **P2 & P3 (LR & VOC Parte 1):** História do Tom em 16.5pt, rotina de CEO, Present Perfect contínuo e Tradução Falada Real.<br/>• **P4 (VOC Deep Dive):** 3 cards com "O Sentimento da Estrutura" (*have been married*, *50-year-old*, *get to see*) sem jargões.<br/>• **P5 a P8 (Workbook):** LA sem respostas impressas, palco Look & Retell AI Coach, LASK sem perguntas reveladas e PRO com texto integral de LR com linking sounds e Sacada de Ouro. |
| **Livro Oficial MS003 (Saturday Morning)** | [`Material-PDF/MS003_Saturday_Morning_Apostila_Oficial.pdf`](file:///Users/macbookpro/Desktop/agoraeufalo_site/Material-PDF/MS003_Saturday_Morning_Apostila_Oficial.pdf) | **Template Canônico dos 3 Arquétipos em 8 Páginas (Fontes 13.5 a 17pt):**<br/>• **P1 (Capa Deep Navy):** Fundo Solid Deep Navy, marca d'água `"03"`, nova foto da Grazi em Brasília 1:1, ficha técnica e sinopse.<br/>• **P2 & P3 (LR & VOC Parte 1):** Manhã de sábado em Brasília em 16.5pt, café em família, itens de mesa e Tradução Falada Real.<br/>• **P4 (VOC Deep Dive):** As 4 Estações do Ano, termômetro falado de clima (*Hot ➔ Freezing*), *downstairs/upstairs* e *where in the world*.<br/>• **P5 a P8 (Workbook):** LA sem respostas impressas, palco Look & Retell AI Coach, LASK sem perguntas reveladas e PRO com texto integral de LR com linking sounds e Sacada de Ouro. |
