...
(async () => {
  ...
  await page.evaluate(() => {
    // evaluate runs in the context of the page, where openCreateVipSpaceModal is defined globally
    openCreateVipSpaceModal('estevao', 'Estêvão Pinheiro', 'estevaopin@gmail.com');
  });
