...
output_dir = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms014'
os.makedirs(output_dir, exist_ok=True)

source_img_path = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS014_Jeremy_goes_to_town/MS014.jpeg'
...
activities = [
    {
        ...
        'sub': 'Imersão Sonora • Jeremy Goes to Town (Picape, Becky & Red Robin\'s)'
    },
    {
        'key': 'voc',
        'code': 'VOC',
        ...
        'sub': 'Expressões Idiomáticas (Night on the town, Grab a bite, Stick around)'
    },
    {
        'key': 'la',
        'code': 'LA',
        ...
        'sub': 'Perguntas de Bate-Pronto sobre a Noite de Jeremy e Becky'
    },
    {
        'key': 'lrt',
        'code': 'LRT',
        ...
        'sub': 'Speaking Ativo • O Encontro Embaraçoso: 16 vs 21 Anos'
    },
    {
        'key': 'lask',
        'code': 'LASK',
        ...
        'sub': 'Formulação Rápida de Perguntas Narrativas'
    },
    {
        'key': 'pro',
        'code': 'PRO',
        ...
        'sub': 'Reduções Rápidas: \'I gotta get going!\' & \'Grab a bite\''
    }
]
...
for act in activities:
    ...
    out_file = os.path.join(output_dir, f"thumb_ms014_{act['key']}.jpg")
...
cover_1_1_path = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/cover-ms014-jeremy-goes-to-town.jpg'
