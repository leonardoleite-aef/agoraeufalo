...
source_dir = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS009_Grammar_practice'
...
lessons = [
    {
        ...
        'file': 'MS009_LR_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS009/MS009_LR_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS009/audio_ms009_lr.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS009/thumb_ms009_lr.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms009/thumb_ms009_lr.jpg'
    },
    {
        'id': 'ms009-voc',
        'title': 'Aula 02 • Vocabulary Session (VOC)',
        'activity': 'vocab',
        'file': 'MS009_VOC_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS009/MS009_VOC_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS009/audio_ms009_voc.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS009/thumb_ms009_voc.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms009/thumb_ms009_voc.jpg'
    },
    {
        'id': 'ms009-la',
        ...
        'file': 'MS009_LA_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS009/MS009_LA_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS009/audio_ms009_la.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS009/thumb_ms009_la.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms009/thumb_ms009_la.jpg'
    },
    {
        'id': 'ms009-lrt',
        'title': 'Aula 04 • Look & Retell (LRT)',
        'activity': 'look_retell',
        'file': 'MS009_LRT_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS009/MS009_LRT_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS009/audio_ms009_lrt.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS009/thumb_ms009_lrt.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms009/thumb_ms009_lrt.jpg'
    },
    {
        'id': 'ms009-lask',
        'title': 'Aula 05 • Listen & Ask (LASK)',
        'activity': 'listen_ask',
        'file': 'MS009_LASK_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS009/MS009_LASK_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS009/audio_ms009_lask.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS009/thumb_ms009_lask.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms009/thumb_ms009_lask.jpg'
    },
    {
        'id': 'ms009-pro',
        'title': 'Aula 06 • Pronunciation & Connected Speech',
        'activity': 'pronunciation',
        'file': 'MS009_PRO_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS009/MS009_PRO_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS009/audio_ms009_pro.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS009/thumb_ms009_pro.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms009/thumb_ms009_pro.jpg'
    }
]

print("=== INICIANDO ESTEIRA MS009 (The Story in 5 Years) ===")

pdf_path = os.path.join(source_dir, 'MS 009 The story in five years.pdf')
local_pdf_dest = '/Users/macbookpro/Desktop/agoraeufalo_site/Material-PDF/MS009_The_Story_in_Five_Years_Apostila_Oficial.pdf'
with open(pdf_path, 'rb') as f_in, open(local_pdf_dest, 'wb') as f_out:
    f_out.write(f_in.read())
print(f"PDF copiado para: {local_pdf_dest}")

cloud_pdf = 'courses/ms-legacy/MS009/MS009_The_Story_in_Five_Years_Apostila_Oficial.pdf'
...
for item in lessons:
    ...
    ms009_results.append({
        ...
        'localThumbnail': f"assets/images/thumbs/ms009/thumb_{item['id'].replace('-', '_')}.jpg",
        'pdfUrl': "Material-PDF/MS009_The_Story_in_Five_Years_Apostila_Oficial.pdf",
        'sentences': sentences
    })

with open('/tmp/ms009_processed_data.json', 'w', encoding='utf-8') as f:
    json.dump(ms009_results, f, indent=2, ensure_ascii=False)

print("\n=== TODAS AS 6 AULAS DO MS009 PROCESSADAS COM SUCESSO! ===")
