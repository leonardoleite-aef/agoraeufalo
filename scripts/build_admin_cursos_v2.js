    ...
    <section class="lg:col-span-5 bg-[#0A192F] border border-white/10 rounded-2xl p-4 sm:p-5 flex flex-col h-[calc(100vh-80px)] overflow-hidden shadow-xl">
      ...
      <form id="lessonEditorForm" onsubmit="handleSaveLesson(event)" class="flex-1 overflow-y-auto custom-scrollbar space-y-4 pr-1 py-3">
        ...
        <div class="p-3.5 rounded-2xl bg-white/5 border border-white/10 space-y-2.5">
          ...
          <!-- Direct Upload Button & Manual URL Button -->
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <label class="flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs uppercase tracking-wider cursor-pointer shadow transition">
            ...
            <button type="button" onclick="toggleManualUrl('video')" class="px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-slate-300 font-bold text-xs flex items-center justify-center gap-1.5">
              <i data-lucide="link" class="w-3.5 h-3.5"></i>
              <span>URL Manual / Link</span>
            </button>
          </div>
        ...
        <div class="p-3.5 rounded-2xl bg-white/5 border border-white/10 space-y-2.5">
          ...
          <!-- Direct Upload Button & Manual URL Button -->
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <label class="flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black text-xs uppercase tracking-wider cursor-pointer shadow transition">
              <i data-lucide="upload" class="w-4 h-4"></i>
            ...
            <button type="button" onclick="toggleManualUrl('audio')" class="px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-slate-300 font-bold text-xs flex items-center justify-center gap-1.5">
              <i data-lucide="link" class="w-3.5 h-3.5"></i>
              <span>URL Manual / Link</span>
            </button>
          </div>
