...
source_dir = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS007_Anna_decision'
...
lessons = [
    {
        ...
        'file': 'MS007_LR_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS007/MS007_LR_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS007/audio_ms007_lr.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS007/thumb_ms007_lr.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms007/thumb_ms007_lr.jpg'
    },
    {
        'id': 'ms007-voc',
        'title': 'Aula 02 • Vocabulary Session (VOC)',
        'activity': 'vocab',
        'file': 'MS007_VOC_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS007/MS007_VOC_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS007/audio_ms007_voc.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS007/thumb_ms007_voc.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms007/thumb_ms007_voc.jpg'
    },
    {
        'id': 'ms007-la',
        ...
        'file': 'MS007_LA_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS007/MS007_LA_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS007/audio_ms007_la.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS007/thumb_ms007_la.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms007/thumb_ms007_la.jpg'
    },
    {
        'id': 'ms007-lrt',
        'title': 'Aula 04 • Look & Retell (LRT)',
        'activity': 'look_retell',
        'file': 'MS007_LRT_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS007/MS007_LRT_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS007/audio_ms007_lrt.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS007/thumb_ms007_lrt.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms007/thumb_ms007_lrt.jpg'
    },
    {
        'id': 'ms007-lask',
        'title': 'Aula 05 • Listen & Ask (LASK)',
        'activity': 'listen_ask',
        'file': 'MS007_LASK_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS007/MS007_LASK_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS007/audio_ms007_lask.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS007/thumb_ms007_lask.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms007/thumb_ms007_lask.jpg'
    },
    {
        'id': 'ms007-pro',
        'title': 'Aula 06 • Pronunciation & Connected Speech',
        'activity': 'pronunciation',
        'file': 'MS007_PRO_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS007/MS007_PRO_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS007/audio_ms007_pro.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS007/thumb_ms007_pro.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms007/thumb_ms007_pro.jpg'
    }
]

print("=== INICIANDO ESTEIRA MS007 (Anna's Decision) ===")

# 1. Upload do PDF Diagramado Oficial
pdf_path = os.path.join(source_dir, 'MS 007 Annas Decision.pdf')
local_pdf_dest = '/Users/macbookpro/Desktop/agoraeufalo_site/Material-PDF/MS007_Annas_Decision_Apostila_Oficial.pdf'
with open(pdf_path, 'rb') as f_in, open(local_pdf_dest, 'wb') as f_out:
    f_out.write(f_in.read())
print(f"PDF copiado para Material-PDF: {local_pdf_dest}")

cloud_pdf = 'courses/ms-legacy/MS007/MS007_Annas_Decision_Apostila_Oficial.pdf'
...
for item in lessons:
    ...
    ms007_results.append({
        ...
        'localThumbnail': f"assets/images/thumbs/ms007/thumb_{item['id'].replace('-', '_')}.jpg",
        'pdfUrl': "Material-PDF/MS007_Annas_Decision_Apostila_Oficial.pdf",
        'sentences': sentences
    })

with open('/tmp/ms007_processed_data.json', 'w', encoding='utf-8') as f:
    json.dump(ms007_results, f, indent=2, ensure_ascii=False)

print("\n=== TODAS AS 6 AULAS DO MS007 PROCESSADAS COM SUCESSO! ===")
