...
source_dir = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS014_Jeremy_goes_to_town'
...
lessons = [
    {
        ...
        'file': 'MS014_LR_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS014/MS014_LR_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS014/audio_ms014_lr.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS014/thumb_ms014_lr.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms014/thumb_ms014_lr.jpg'
    },
    {
        'id': 'ms014-voc',
        'title': 'Aula 02 • Vocabulary Session (VOC)',
        'activity': 'vocab',
        'file': 'MS014_VOC_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS014/MS014_VOC_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS014/audio_ms014_voc.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS014/thumb_ms014_voc.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms014/thumb_ms014_voc.jpg'
    },
    {
        'id': 'ms014-la',
        ...
        'file': 'MS014_LA_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS014/MS014_LA_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS014/audio_ms014_la.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS014/thumb_ms014_la.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms014/thumb_ms014_la.jpg'
    },
    {
        'id': 'ms014-lrt',
        'title': 'Aula 04 • Look & Retell (LRT)',
        'activity': 'look_retell',
        'file': 'MS014_LRT_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS014/MS014_LRT_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS014/audio_ms014_lrt.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS014/thumb_ms014_lrt.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms014/thumb_ms014_lrt.jpg'
    },
    {
        'id': 'ms014-lask',
        'title': 'Aula 05 • Listen & Ask (LASK)',
        'activity': 'listen_ask',
        'file': 'MS014_LASK_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS014/MS014_LASK_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS014/audio_ms014_lask.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS014/thumb_ms014_lask.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms014/thumb_ms014_lask.jpg'
    },
    {
        'id': 'ms014-pro',
        'title': 'Aula 06 • Pronunciation & Connected Speech',
        'activity': 'pronunciation',
        'file': 'MS014_PRO_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS014/MS014_PRO_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS014/audio_ms014_pro.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS014/thumb_ms014_pro.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms014/thumb_ms014_pro.jpg'
    }
]

print("=== INICIANDO ESTEIRA MS014 (Jeremy Goes to Town) ===")

pdf_path = os.path.join(source_dir, 'MS 014 Jeremy Goes to Town.pdf')
local_pdf_dest = '/Users/macbookpro/Desktop/agoraeufalo_site/Material-PDF/MS014_Jeremy_Goes_to_Town_Apostila_Oficial.pdf'
with open(pdf_path, 'rb') as f_in, open(local_pdf_dest, 'wb') as f_out:
    f_out.write(f_in.read())
print(f"PDF copiado para: {local_pdf_dest}")

cloud_pdf = 'courses/ms-legacy/MS014/MS014_Jeremy_Goes_to_Town_Apostila_Oficial.pdf'
...
for item in lessons:
    ...
    ms014_results.append({
        ...
        'localThumbnail': f"assets/images/thumbs/ms014/thumb_{item['id'].replace('-', '_')}.jpg",
        'pdfUrl': "Material-PDF/MS014_Jeremy_Goes_to_Town_Apostila_Oficial.pdf",
        'sentences': sentences
    })

with open('/tmp/ms014_processed_data.json', 'w', encoding='utf-8') as f:
    json.dump(ms014_results, f, indent=2, ensure_ascii=False)

print("\n=== TODAS AS 6 AULAS DO MS014 PROCESSADAS COM SUCESSO! ===")
