"""
AgoraEuFalo Master Thumbnail Engine - MS003 Saturday Morning (16:9 Video Covers)
...
MODULE_INFO = {
    "module_id": "ms003",
    "module_code": "MS003",
    "module_title": "Saturday Morning",
    "base_art": "assets/images/cover-grazi-session03.jpg",
    "output_dir": "assets/images/thumbs/ms003"
}
...
LESSONS_CONFIG = [
    ...
    },
    {
        "id": "ms003_la",
        "order": 3,
        "badge": "MÓDULO MS003 • AULA 03",
        "title": "LISTEN & ANSWER",
        "tag": "LA",
        "subtitle": "Reflexo & Velocidade de Resposta",
        "concept": "14 perguntas de bate-pronto na micro-pausa",
...
def create_thumbnail(cfg, module_info):
    ...
    # Salvar Thumbnail em Alta Definição (<140 KB)
...
if __name__ == '__main__':
    ...
    print("All 6 lesson thumbnails for MS003 successfully created!")
