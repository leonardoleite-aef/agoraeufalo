...
source_dir = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS011_Meet_Jeremy'
...
lessons = [
    {
        ...
        'file': 'MS011_LR_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS011/MS011_LR_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS011/audio_ms011_lr.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS011/thumb_ms011_lr.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms011/thumb_ms011_lr.jpg'
    },
    {
        'id': 'ms011-voc',
        'title': 'Aula 02 • Vocabulary Session (VOC)',
        'activity': 'vocab',
        'file': 'MS011_VOC_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS011/MS011_VOC_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS011/audio_ms011_voc.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS011/thumb_ms011_voc.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms011/thumb_ms011_voc.jpg'
    },
    {
        'id': 'ms011-la',
        ...
        'file': 'MS011_LA_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS011/MS011_LA_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS011/audio_ms011_la.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS011/thumb_ms011_la.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms011/thumb_ms011_la.jpg'
    },
    {
        'id': 'ms011-lrt',
        'title': 'Aula 04 • Look & Retell (LRT)',
        'activity': 'look_retell',
        'file': 'MS011_LRT_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS011/MS011_LRT_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS011/audio_ms011_lrt.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS011/thumb_ms011_lrt.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms011/thumb_ms011_lrt.jpg'
    },
    {
        'id': 'ms011-lask',
        'title': 'Aula 05 • Listen & Ask (LASK)',
        'activity': 'listen_ask',
        'file': 'MS011_LASK_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS011/MS011_LASK_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS011/audio_ms011_lask.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS011/thumb_ms011_lask.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms011/thumb_ms011_lask.jpg'
    },
    {
        'id': 'ms011-pro',
        'title': 'Aula 06 • Pronunciation & Connected Speech',
        'activity': 'pronunciation',
        'file': 'MS011_PRO_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS011/MS011_PRO_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS011/audio_ms011_pro.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS011/thumb_ms011_pro.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms011/thumb_ms011_pro.jpg'
    }
]

print("=== INICIANDO ESTEIRA MS011 (Meet Jeremy) ===")

pdf_path = os.path.join(source_dir, 'MS 011 Meet Jeremy PDF.pdf')
local_pdf_dest = '/Users/macbookpro/Desktop/agoraeufalo_site/Material-PDF/MS011_Meet_Jeremy_Apostila_Oficial.pdf'
with open(pdf_path, 'rb') as f_in, open(local_pdf_dest, 'wb') as f_out:
    f_out.write(f_in.read())
print(f"PDF copiado para: {local_pdf_dest}")

cloud_pdf = 'courses/ms-legacy/MS011/MS011_Meet_Jeremy_Apostila_Oficial.pdf'
...
for item in lessons:
    ...
    ms011_results.append({
        ...
        'localThumbnail': f"assets/images/thumbs/ms011/thumb_{item['id'].replace('-', '_')}.jpg",
        'pdfUrl': "Material-PDF/MS011_Meet_Jeremy_Apostila_Oficial.pdf",
        'sentences': sentences
    })

with open('/tmp/ms011_processed_data.json', 'w', encoding='utf-8') as f:
    json.dump(ms011_results, f, indent=2, ensure_ascii=False)

print("\n=== TODAS AS 6 AULAS DO MS011 PROCESSADAS COM SUCESSO! ===")
