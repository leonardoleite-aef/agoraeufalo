...
output_dir = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms012'
os.makedirs(output_dir, exist_ok=True)

source_img_path = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS012_Driver\'s License/MS012_1.jpeg'
...
activities = [
    {
        'key': 'lr_1',
        'code': 'LR',
        'badge': 'LISTEN & READ (LEGACY)',
        'color': '#1A56DB', # Azul Cobalto
        'title': 'Aula 01.1 • Listen & Read (LR Legacy)',
        'sub': 'Imersão Sonora • Driver\'s License (Jeremy aos 16)'
    },
    {
        'key': 'lr_2',
        'code': 'LR',
        'badge': 'LISTEN & READ (EXTENDED)',
        'color': '#1E40AF', # Azul Escuro
        'title': 'Aula 01.2 • Listen & Read (LR Extended)',
        'sub': 'Fluência Guiada & Leitura Contínua'
    },
    {
        'key': 'voc',
        'code': 'VOC',
        ...
        'sub': 'Driver\'s Ed, Permissão & Estruturas de Futuro Imediato'
    },
    {
        'key': 'la',
        'code': 'LA',
        ...
        'sub': 'Perguntas de Reflexo sobre a CNH Americana'
    },
    {
        'key': 'lrt',
        'code': 'LRT',
        ...
        'sub': 'Speaking Ativo • A Conquista da Carteira aos 16 Anos'
    },
    {
        'key': 'lask',
        'code': 'LASK',
        ...
        'sub': 'Formulação Rápida de Perguntas (Can/Can\'t/Going to)'
    },
    {
        'key': 'pro_1',
        'code': 'PRO',
        'badge': 'PRONUNCIATION (PART 1)',
        'color': '#0D9488', # Teal Ciano
        'title': 'Aula 06.1 • Pronunciation & Connected Speech',
        'sub': 'Conexões de Driver\'s License & Ritmo Falado'
    },
    {
        'key': 'pro_2',
        'code': 'PRO',
        'badge': 'PRONUNCIATION (PART 2)',
        'color': '#0F766E', # Teal Escuro
        'title': 'Aula 06.2 • Pronunciation Deep Dive',
        'sub': 'Sacada de Ouro do Leo & Treino Contínuo'
    }
]
...
for act in activities:
    ...
    out_file = os.path.join(output_dir, f"thumb_ms012_{act['key']}.jpg")
...
cover_1_1_path = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/cover-ms012-drivers-license.jpg'
