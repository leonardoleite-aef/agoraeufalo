...
output_dir = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms009'
os.makedirs(output_dir, exist_ok=True)

source_img_path = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS009_Grammar_practice/MS009_1.jpeg'
...
activities = [
    {
        ...
        'sub': 'Imersão Sonora • The Story in 5 Years'
    },
    {
        'key': 'voc',
        'code': 'VOC',
        ...
        'sub': 'As 3 Formas do Futuro (Will / Going to / Gonna)'
    },
    {
        'key': 'la',
        'code': 'LA',
        ...
        'sub': 'Reflexo Imediato no Futuro • Bate-Pronto'
    },
    {
        'key': 'lrt',
        'code': 'LRT',
        ...
        'sub': 'Speaking Ativo • Projeção dos Próximos 5 Anos'
    },
    {
        'key': 'lask',
        'code': 'LASK',
        ...
        'sub': 'Formulação Rápida de Perguntas no Futuro'
    },
    {
        'key': 'pro',
        'code': 'PRO',
        ...
        'sub': 'Reduções de Gonna e Contrações de Will (\'ll)'
    }
]
...
for act in activities:
    ...
    out_file = os.path.join(output_dir, f"thumb_ms009_{act['key']}.jpg")
...
cover_1_1_path = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/cover-ms009-the-story-in-5-years.jpg'
