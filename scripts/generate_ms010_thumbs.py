...
output_dir = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms010'
os.makedirs(output_dir, exist_ok=True)

source_img_path = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS010_An_english_student/MS010.jpeg'
...
activities = [
    {
        ...
        'sub': 'Imersão Sonora • An English Student (Carlos)'
    },
    {
        'key': 'lr_2',
        'code': 'LR',
    ...
    },
    {
        ...
        'sub': 'Autobiografia, Carreira & Chunks de Apresentação'
    },
    {
        'key': 'la',
        'code': 'LA',
        ...
        'sub': 'Perguntas Pessoais de Bate-Pronto'
    },
    {
        'key': 'lrt',
        'code': 'LRT',
        ...
        'sub': 'Speaking Ativo • Tell Me About Yourself!'
    },
    {
        'key': 'lask',
        'code': 'LASK',
        ...
        'sub': 'Formulação de Perguntas Autobiográficas'
    },
    {
        'key': 'pro',
        'code': 'PRO',
        ...
        'sub': 'Conexões de Apresentação Pessoal & Sacada do Leo'
    }
]
...
for act in activities:
    ...
    out_file = os.path.join(output_dir, f"thumb_ms010_{act['key']}.jpg")
...
cover_1_1_path = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/cover-ms010-an-english-student.jpg'
