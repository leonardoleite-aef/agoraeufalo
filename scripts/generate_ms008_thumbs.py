...
output_dir = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms008'
os.makedirs(output_dir, exist_ok=True)

source_img_path = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS008_Back_in_1999/MS008.jpeg'
...
activities = [
    {
        ...
        'sub': 'Imersão Sonora • Back in 1999'
    },
    {
        'key': 'voc',
        'code': 'VOC',
        ...
        'sub': 'Tabela de Verbos no Passado & Chunks'
    },
    {
        'key': 'la',
        'code': 'LA',
        ...
        'sub': 'Reflexo no Passado • 20 Perguntas de Bate-Pronto'
    },
    {
        'key': 'lrt',
        'code': 'LRT',
        ...
        'sub': 'Speaking Ativo • A Linha do Tempo de 1999'
    },
    {
        'key': 'lask',
        'code': 'LASK',
        ...
        'sub': 'Negações e Formulação de Perguntas'
    },
    {
        'key': 'pro',
        'code': 'PRO',
        ...
        'sub': 'Pronúncia dos Verbos Regulares e Irregulares'
    }
]
...
for act in activities:
    ...
    out_file = os.path.join(output_dir, f"thumb_ms008_{act['key']}.jpg")
...
cover_1_1_path = '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/cover-ms008-back-in-1999.jpg'
