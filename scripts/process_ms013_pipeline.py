...
source_dir = '/Users/macbookpro/Downloads/MS_MIGRACAO/MS013_Verb_tense_practice'
...
lessons = [
    {
        ...
        'file': 'MS013_LR_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS013/MS013_LR_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS013/audio_ms013_lr.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS013/thumb_ms013_lr.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms013/thumb_ms013_lr.jpg'
    },
    {
        'id': 'ms013-voc',
        'title': 'Aula 02 • Vocabulary Session (VOC)',
        'activity': 'vocab',
        'file': 'MS013_VOC_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS013/MS013_VOC_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS013/audio_ms013_voc.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS013/thumb_ms013_voc.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms013/thumb_ms013_voc.jpg'
    },
    {
        'id': 'ms013-la',
        ...
        'file': 'MS013_LA_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS013/MS013_LA_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS013/audio_ms013_la.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS013/thumb_ms013_la.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms013/thumb_ms013_la.jpg'
    },
    {
        'id': 'ms013-lrt',
        'title': 'Aula 04 • Look & Retell (LRT)',
        'activity': 'look_retell',
        'file': 'MS013_LRT_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS013/MS013_LRT_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS013/audio_ms013_lrt.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS013/thumb_ms013_lrt.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms013/thumb_ms013_lrt.jpg'
    },
    {
        'id': 'ms013-lask',
        'title': 'Aula 05 • Listen & Ask (LASK)',
        'activity': 'listen_ask',
        'file': 'MS013_LASK_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS013/MS013_LASK_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS013/audio_ms013_lask.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS013/thumb_ms013_lask.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms013/thumb_ms013_lask.jpg'
    },
    {
        'id': 'ms013-pro',
        'title': 'Aula 06 • Pronunciation & Connected Speech',
        'activity': 'pronunciation',
        'file': 'MS013_PRO_1.mp4',
        'cloud_mp4': 'courses/magic-stories-legacy/MS013/MS013_PRO_1.mp4',
        'cloud_mp3': 'courses/ms-legacy/MS013/audio_ms013_pro.mp3',
        'cloud_thumb': 'courses/ms-legacy/MS013/thumb_ms013_pro.jpg',
        'local_thumb': '/Users/macbookpro/Desktop/agoraeufalo_site/assets/images/thumbs/ms013/thumb_ms013_pro.jpg'
    }
]

print("=== INICIANDO ESTEIRA MS013 (Verb Tense Practice) ===")

pdf_path = os.path.join(source_dir, 'MS 013 Verb Tense Practice.pdf')
local_pdf_dest = '/Users/macbookpro/Desktop/agoraeufalo_site/Material-PDF/MS013_Verb_Tense_Practice_Apostila_Oficial.pdf'
with open(pdf_path, 'rb') as f_in, open(local_pdf_dest, 'wb') as f_out:
    f_out.write(f_in.read())
print(f"PDF copiado para: {local_pdf_dest}")

cloud_pdf = 'courses/ms-legacy/MS013/MS013_Verb_Tense_Practice_Apostila_Oficial.pdf'
...
for item in lessons:
    ...
    ms013_results.append({
        ...
        'localThumbnail': f"assets/images/thumbs/ms013/thumb_{item['id'].replace('-', '_')}.jpg",
        'pdfUrl': "Material-PDF/MS013_Verb_Tense_Practice_Apostila_Oficial.pdf",
        'sentences': sentences
    })

with open('/tmp/ms013_processed_data.json', 'w', encoding='utf-8') as f:
    json.dump(ms013_results, f, indent=2, ensure_ascii=False)

print("\n=== TODAS AS 6 AULAS DO MS013 PROCESSADAS COM SUCESSO! ===")
